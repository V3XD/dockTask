...
public class Folders : Singleton<Folders> 
{
	...
	string folderPath;
	string columns = "Time,Distance,Angle,Difficulty,initDistance,initAngle,clutchTime,clutchCount,tab,xRotI,yRotI,zRotI,xRotChair,yRotChair,zRotChair,interaction";
