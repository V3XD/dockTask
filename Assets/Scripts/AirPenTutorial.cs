...
public class AirPenTutorial : MonoBehaviour {
	...
	void Awake ()
	{
		...
		path = @"Log/"+difficulty.getLevel()+"/"+System.DateTime.Now.ToString("MM-dd-yy_hh-mm-ss")+difficulty.getLevel()+"_AirPenTutorial.csv";
